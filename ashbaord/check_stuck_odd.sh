...
#	If delay is more that '50 Minutes', it would trigger a Yamas Alert.
...
then
	...
	elif [ $stuck_position -ge 2 -a $stuck_position -le 12 ];
	then
...
echo "Completed for East1-15 and West1-7 (Set-1), Daily Yahoo! over for $DATE"
fi
